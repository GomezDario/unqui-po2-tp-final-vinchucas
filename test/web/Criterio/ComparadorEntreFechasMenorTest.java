...
private ComparadorEntreFechasMenor comparador;
    ...
    void testCompararEntre_FechaAMayorQueFechaB() {
        ...
        LocalDateTime fechaA = LocalDateTime.of(2023, 8, 10, 10, 0); // Fecha A 
        LocalDateTime fechaB = LocalDateTime.of(2023, 7, 10, 10, 0); // Fecha B 
    ...
    void testCompararEntre_FechaAMenorQueFechaB() {
    	...
    	LocalDateTime fechaA = LocalDateTime.of(2023, 5, 10, 10, 0); // Fecha A 
